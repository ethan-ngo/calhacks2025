...
def patient_chat():
    ...
    try:
        ...
        # Check if triage score has worsened (lower number = more urgent)
        ...
        # If new triage is MORE urgent (lower number), create alert
        ...
        return jsonify({
            ...
            "triage_score": assessment.get('triage_score'),
            "alert_created": current_triage < original_triage,
            "success": True
        })
...
def send_patient_link_sms(phone_number: str, patient_name: str, link: str) -> bool:
    ...
    try:
        ...
        message = client.messages.create(
            body=f"Hello {patient_name}, access your ER wait portal: {link}",
            from_=from_number,
            to=phone_number
        )
